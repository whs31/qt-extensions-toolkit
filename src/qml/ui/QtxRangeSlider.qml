...
T.RangeSlider {
    ...
    implicitWidth: Math.max(implicitBackgroundWidth + leftInset + rightInset,
                            first.implicitHandleWidth + leftPadding + rightPadding,second.implicitHandleWidth + leftPadding + rightPadding)
    implicitHeight: Math.max(implicitBackgroundHeight + topInset + bottomInset,
                             first.implicitHandleHeight + topPadding + bottomPadding, second.implicitHandleHeight + topPadding + bottomPadding)
    padding: 6
    first.value: 0
    second.value: 100
    stepSize: 1
    ...
    first.handle: Rectangle {
        ...
        FluentTTFIcon {
            ...
            iconSize: 10
            scale: {
                if(control.first.pressed) return 0.9
    ...
    second.handle: Rectangle {
        ...
        FluentTTFIcon{
            ...
            iconSize: 10
            scale:{
                if(control.second.pressed) return 0.9
